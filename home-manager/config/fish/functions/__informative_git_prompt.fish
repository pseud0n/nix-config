...
function __informative_git_prompt --description 'Write out the git prompt'
	...
	#    end
	#
    printf "%s%s/%s" (___fish_git_print_branch_info) (set_color -o $fish_color_git_branch) $git_status_info
